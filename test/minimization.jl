...
@test_nowarn SolePostHoc.InTreesRuleExtractor()(solem, X, y; silent = true, normalize = true)
@test_nowarn SolePostHoc.RuleExtraction.intrees(solem, X, y; silent = true, normalize = true)
...
@test_nowarn SolePostHoc.extractrules(SolePostHoc.RuleExtractor.InTreesRuleExtractor(), solem)
...
@test_nowarn SolePostHoc.LumenRuleExtractor(fitted_params(mach).forest, apply_function = DT.apply_forest)
