...
extracted_rules = RuleExtraction.modalextractrules(extractor, solem_dt, Xc[test, :], yc[test])
extracted_rules = RuleExtraction.modalextractrules(extractor, solem_dt, Xc[test, :], yc[test]; min_coverage=1.0)
@test_throws MethodError RuleExtraction.modalextractrules(extractor, solem_dt, Xc[test, :], yc[test]; invalid=true)
...
extracted_rules = RuleExtraction.modalextractrules(extractor, solem_dt; minimization_scheme=:mitespresso);

extracted_rules = RuleExtraction.modalextractrules(extractor, solem_rf);
extracted_rules = RuleExtraction.modalextractrules(extractor, solem_rf; minimization_scheme=:mitespresso);
...
extracted_rules = RuleExtraction.modalextractrules(extractor, solem_rf; dataset_name="Sole_Analysis")
extracted_rules = RuleExtraction.modalextractrules(extractor, solem_rf; dataset_name="Sole_Analysis", num_trees=5)
...
extracted_rules = RuleExtraction.modalextractrules(extractor, solem_rf, Xc[test, :], yc[test])
